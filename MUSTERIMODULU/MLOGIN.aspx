<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MLOGIN.aspx.cs" Inherits="MT_e_SATIS.MUSTERIMODULU.MLOGIN" %>
...
<body style="background-color: transparent; background-image: url(/blackwp1.jpg); background-position: center center;background-repeat:no-repeat;margin:0px 0px 0px 0px;background-size:100%;padding:0px 0px 0px 0px;">
    ...
    <form runat="server" class="form-group">
        ...
        <div style="margin-left: 470px">
            <asp:Label ID="Label6" runat="server" Text="Label" ForeColor="White">Müşteri Kullanıcı Adı :</asp:Label>
            <asp:TextBox ID="txtkullaniciadi" runat="server" CssClass="form-control" type="text" Width="300px"></asp:TextBox>
        </div>
      <%--  <br />--%>
        <div style="margin-left: 470px">
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<asp:Label ID="Label7" runat="server" Text="Label" ForeColor="White">Müşteri Şifre :</asp:Label>
            <asp:TextBox ID="txtsifre" runat="server" CssClass="form-control" type="password" Width="300px"></asp:TextBox>
        </div>

        <div style="margin-left: 707px">
            <asp:Button ID="Button2" runat="server" Text="Giriş" class="btn btn-success" OnClick="Button2_Click" Width="200px" BackColor="Blue"/>
        </div>
